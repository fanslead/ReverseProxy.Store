...
namespace ReverseProxy.Store.EFCore
{
    public interface IReverseProxyStoreDbContext
    {
        ...
        DbSet<ProxyHttpClientOptions> ProxyHttpClientOptions { get; set; }
        DbSet<ProxyMatch> ProxyMatches { get; set; }
        DbSet<RequestProxyOptions> RequestProxyOptions { get; set; }
        DbSet<RouteHeader> RouteHeaders { get; set; }
        DbSet<SessionAffinityOptions> SessionAffinityOptions { get; set; }
